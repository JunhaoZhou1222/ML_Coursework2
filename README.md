...
- **Adding Temperature**: In the context of SimCLR's contrastive loss, adding temperature parameter 0.1 makes the model more sensitive to hard negatives. This creates a stricter, more highly separated feature space, resulting in embeddings that are more stable, precise, and consistent for downstream classification.
